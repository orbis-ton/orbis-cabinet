...
export function loadCalculateDistribution(slice: Slice) {
    ...
    return { $$type: 'CalculateDistribution' as const, currentBalance: _currentBalance, chunkSize: _chunkSize };
}
...
export type GiverData = {
    $$type: 'GiverData';
    owner: Address;
    myJettonWalletAddress: Address | null;
    nftCollectionAddress: Address;
    nftPriceInTokens: bigint;
    lastRewardDistribution: bigint;
    nextItemIndex: bigint;
    toDistribute: Dictionary<number, bigint>;
    balance: bigint;
    balanceFree: bigint;
}
...
export function storeGiverData(src: GiverData) {
    return (builder: Builder) => {
        ...
        const b_1 = new Builder();
        b_1.storeInt(src.nftPriceInTokens, 257);
        b_1.storeInt(src.lastRewardDistribution, 257);
        b_1.storeInt(src.nextItemIndex, 257);
        b_1.storeDict(src.toDistribute, Dictionary.Keys.Uint(16), Dictionary.Values.BigVarUint(4));
        b_1.storeCoins(src.balance);
        b_1.storeCoins(src.balanceFree);
        b_0.storeRef(b_1.endCell());
    };
}
...
export function loadGiverData(slice: Slice) {
    const sc_0 = slice;
    const _owner = sc_0.loadAddress();
    const _myJettonWalletAddress = sc_0.loadMaybeAddress();
    const _nftCollectionAddress = sc_0.loadAddress();
    const sc_1 = sc_0.loadRef().beginParse();
    const _nftPriceInTokens = sc_1.loadIntBig(257);
    const _lastRewardDistribution = sc_1.loadIntBig(257);
    const _nextItemIndex = sc_1.loadIntBig(257);
    const _toDistribute = Dictionary.load(Dictionary.Keys.Uint(16), Dictionary.Values.BigVarUint(4), sc_1);
    const _balance = sc_1.loadCoins();
    const _balanceFree = sc_1.loadCoins();
    return { $$type: 'GiverData' as const, owner: _owner, myJettonWalletAddress: _myJettonWalletAddress, nftCollectionAddress: _nftCollectionAddress, nftPriceInTokens: _nftPriceInTokens, lastRewardDistribution: _lastRewardDistribution, nextItemIndex: _nextItemIndex, toDistribute: _toDistribute, balance: _balance, balanceFree: _balanceFree };
}

function loadTupleGiverData(source: TupleReader) {
    const _owner = source.readAddress();
    const _myJettonWalletAddress = source.readAddressOpt();
    const _nftCollectionAddress = source.readAddress();
    const _nftPriceInTokens = source.readBigNumber();
    const _lastRewardDistribution = source.readBigNumber();
    const _nextItemIndex = source.readBigNumber();
    const _toDistribute = Dictionary.loadDirect(Dictionary.Keys.Uint(16), Dictionary.Values.BigVarUint(4), source.readCellOpt());
    const _balance = source.readBigNumber();
    const _balanceFree = source.readBigNumber();
    return { $$type: 'GiverData' as const, owner: _owner, myJettonWalletAddress: _myJettonWalletAddress, nftCollectionAddress: _nftCollectionAddress, nftPriceInTokens: _nftPriceInTokens, lastRewardDistribution: _lastRewardDistribution, nextItemIndex: _nextItemIndex, toDistribute: _toDistribute, balance: _balance, balanceFree: _balanceFree };
}
...
function storeTupleGiverData(source: GiverData) {
    ...
    builder.writeNumber(source.nftPriceInTokens);
    builder.writeNumber(source.lastRewardDistribution);
    builder.writeNumber(source.nextItemIndex);
    builder.writeCell(source.toDistribute.size > 0 ? beginCell().storeDictDirect(source.toDistribute, Dictionary.Keys.Uint(16), Dictionary.Values.BigVarUint(4)).endCell() : null);
    builder.writeNumber(source.balance);
    builder.writeNumber(source.balanceFree);
    return builder.build();
}
...
export function storeOMGiver$Data(src: OMGiver$Data) {
    return (builder: Builder) => {
        ...
        b_0.storeAddress(src.myJettonWalletAddress);
        b_0.storeCoins(src.balance);
        b_0.storeCoins(src.balanceFree);
        const b_1 = new Builder();
        b_1.storeAddress(src.nftCollectionAddress);
        b_1.storeInt(src.nftPriceInTokens, 257);
        b_1.storeInt(src.lastRewardDistribution, 257);
        const b_2 = new Builder();
        b_2.storeInt(src.nextItemIndex, 257);
        b_2.storeDict(src.toDistribute, Dictionary.Keys.Uint(16), Dictionary.Values.BigVarUint(4));
...
export function loadOMGiver$Data(slice: Slice) {
    ...
    const _myJettonWalletAddress = sc_0.loadMaybeAddress();
    const _balance = sc_0.loadCoins();
    const _balanceFree = sc_0.loadCoins();
    const sc_1 = sc_0.loadRef().beginParse();
    const _nftCollectionAddress = sc_1.loadAddress();
    const _nftPriceInTokens = sc_1.loadIntBig(257);
    const _lastRewardDistribution = sc_1.loadIntBig(257);
    const sc_2 = sc_1.loadRef().beginParse();
    const _nextItemIndex = sc_2.loadIntBig(257);
    const _toDistribute = Dictionary.load(Dictionary.Keys.Uint(16), Dictionary.Values.BigVarUint(4), sc_2);
    return { $$type: 'OMGiver$Data' as const, owner: _owner, myJettonWalletAddress: _myJettonWalletAddress, balance: _balance, balanceFree: _balanceFree, nftCollectionAddress: _nftCollectionAddress, nftPriceInTokens: _nftPriceInTokens, lastRewardDistribution: _lastRewardDistribution, nextItemIndex: _nextItemIndex, toDistribute: _toDistribute };
}
...
function initOMGiver_init_args(src: OMGiver_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
...
async function OMGiver_init(id: bigint, nftCollectionAddress: Address, nextItemIndex: bigint) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    builder.storeUint(0, 1);
    initOMGiver_init_args({ $$type: 'OMGiver_init_args', id, nftCollectionAddress, nextItemIndex })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

export const OMGiver_errors = {
    ...
    13291: { message: `Only my address can calculate distribution chunk` },
    18814: { message: `Distribution map already initialized` },
    25766: { message: `Current balance is less than balance` },
    26825: { message: `Only owner can withdraw` },
    32028: { message: `Item address mismatch` },
    36669: { message: `Only my address can init distribution map` },
    49458: { message: `Only owner can set parameters` },
    57896: { message: `Only owner can init jetton wallet` },
    60500: { message: `Only admin can calculate distribution` },
    62984: { message: `Next item index is out of bounds` },
} as const

export const OMGiver_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
    ...
    "Only my address can calculate distribution chunk": 13291,
    "Distribution map already initialized": 18814,
    "Current balance is less than balance": 25766,
    "Only owner can withdraw": 26825,
    "Item address mismatch": 32028,
    "Only my address can init distribution map": 36669,
    "Only owner can set parameters": 49458,
    "Only owner can init jetton wallet": 57896,
    "Only admin can calculate distribution": 60500,
    "Next item index is out of bounds": 62984,
} as const

const OMGiver_types: ABIType[] = [
    ...
    {"name":"CalculateDistribution","header":1340,"fields":[{"name":"currentBalance","type":{"kind":"simple","type":"uint","optional":true,"format":"coins"}},{"name":"chunkSize","type":{"kind":"simple","type":"uint","optional":false,"format":16}}]},
    ...
    {"name":"GiverData","header":null,"fields":[{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"myJettonWalletAddress","type":{"kind":"simple","type":"address","optional":true}},{"name":"nftCollectionAddress","type":{"kind":"simple","type":"address","optional":false}},{"name":"nftPriceInTokens","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"lastRewardDistribution","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"nextItemIndex","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"toDistribute","type":{"kind":"dict","key":"uint","keyFormat":16,"value":"uint","valueFormat":"coins"}},{"name":"balance","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"balanceFree","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}}]},
    {"name":"OMGiver$Data","header":null,"fields":[{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"myJettonWalletAddress","type":{"kind":"simple","type":"address","optional":true}},{"name":"balance","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"balanceFree","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"nftCollectionAddress","type":{"kind":"simple","type":"address","optional":false}},{"name":"nftPriceInTokens","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"lastRewardDistribution","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"nextItemIndex","type":{"kind":"simple","type":"int","optional":false,"format":257}},{"name":"toDistribute","type":{"kind":"dict","key":"uint","keyFormat":16,"value":"uint","valueFormat":"coins"}}]},
]

const OMGiver_opcodes = {
    "Excesses": 3576854235,
...
const OMGiver_getters: ABIGetter[] = [
    {"name":"get_giver_data","methodId":85156,"arguments":[],"returnType":{"kind":"simple","type":"GiverData","optional":false}},
]

export const OMGiver_getterMapping: { [key: string]: string } = {
    'get_giver_data': 'getGetGiverData',
}

const OMGiver_receivers: ABIReceiver[] = [
    {"receiver":"internal","message":{"kind":"empty"}},
    {"receiver":"internal","message":{"kind":"typed","type":"InitJettonWallet"}},
    {"receiver":"internal","message":{"kind":"typed","type":"InitDistributionMap"}},
    {"receiver":"internal","message":{"kind":"typed","type":"SetParameters"}},
    {"receiver":"internal","message":{"kind":"typed","type":"Withdraw"}},
    {"receiver":"internal","message":{"kind":"typed","type":"JettonTransferNotification"}},
    {"receiver":"internal","message":{"kind":"typed","type":"OwnershipAssigned"}},
    {"receiver":"internal","message":{"kind":"typed","type":"CalculateDistributionChunk"}},
    {"receiver":"internal","message":{"kind":"typed","type":"CalculateDistribution"}},
]
...
export class OMGiver implements Contract {
    
    public static readonly storageReserve = 0n;
    public static readonly errors = OMGiver_errors_backward;
    public static readonly opcodes = OMGiver_opcodes;
    
    static async init(id: bigint, nftCollectionAddress: Address, nextItemIndex: bigint) {
        return await OMGiver_init(id, nftCollectionAddress, nextItemIndex);
    }
    
    static async fromInit(id: bigint, nftCollectionAddress: Address, nextItemIndex: bigint) {
        const __gen_init = await OMGiver_init(id, nftCollectionAddress, nextItemIndex);
        const address = contractAddress(0, __gen_init);
        return new OMGiver(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new OMGiver(address);
    }
    ...
    readonly abi: ContractABI = {
        types:  OMGiver_types,
        getters: OMGiver_getters,
        receivers: OMGiver_receivers,
        errors: OMGiver_errors,
    };
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: null | InitJettonWallet | InitDistributionMap | SetParameters | Withdraw | JettonTransferNotification | OwnershipAssigned | CalculateDistributionChunk | CalculateDistribution) {
        ...
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'InitDistributionMap') {
            body = beginCell().store(storeInitDistributionMap(message)).endCell();
        }
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'SetParameters') {
            body = beginCell().store(storeSetParameters(message)).endCell();
        }
        ...
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'CalculateDistributionChunk') {
            body = beginCell().store(storeCalculateDistributionChunk(message)).endCell();
        }
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'CalculateDistribution') {
            body = beginCell().store(storeCalculateDistribution(message)).endCell();
        }
    ...
    async getGetGiverData(provider: ContractProvider) {
        const builder = new TupleBuilder();
        const source = (await provider.get('get_giver_data', builder.build())).stack;
        const result = loadGetterTupleGiverData(source);
        return result;
    }
